    ...
    public static class UITutorialWindowPatches
    {
            ...
            ILGenerator ilGenerator)
        {
            ...
            matcher.InsertAndAdvance(
                ...
                new CodeInstruction(OpCodes.Call, AccessTools.Method(typeof(UITutorialWindowPatches), nameof(IsOrbitalRingLayout))),
            ...
            matcher.InsertAndAdvance(
                new CodeInstruction(OpCodes.Ldarg_0),
                new CodeInstruction(OpCodes.Ldfld, AccessTools.Field(typeof(UITutorialWindow), nameof(UITutorialWindow.tutorialProto))),
                new CodeInstruction(OpCodes.Call, AccessTools.Method(typeof(UITutorialWindowPatches), nameof(GetOrbitalRingLayoutStr))),
        ...
        public static bool IsOrbitalRingLayout(TutorialProto proto)
        {
            var layoutFileName = proto.LayoutFileName;
            
            return !string.IsNullOrEmpty(layoutFileName) && layoutFileName.StartsWith("orbitalring-tutorials-");
        }

        public static string GetOrbitalRingLayoutStr(TutorialProto proto)
        {
